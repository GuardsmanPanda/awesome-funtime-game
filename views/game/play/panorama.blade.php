...
<button id="map-selector" onclick="dialog('/game/lobby/map-selector')" class="text-sm bg-opacity-70 z-40 absolute bg-gray-800 font-bold px-2 py-0.5 right-0 rounded-bl-md shadow-md text-gray-100 transform hover:scale-110 duration-50 capitalize origin-top-right">{{t('Map style')}}</button>
