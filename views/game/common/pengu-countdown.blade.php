<div id="pengu" class="absolute font-bold right-0 top-0 drop-shadow-lg filter pointer-events-none {{$class ?? ''}}" style="font-family: 'Inkwell Sans',Verdana,sans-serif; z-index: 500;">
    <div class="relative">
...
<div hx-get="/game/{{$game->id}}/play" hx-target="body" hx-trigger="load delay:{{$countdown_seconds +2}}s"></div>
<script>
